...
class TunnelManager: ObservableObject {
    ...
    init() {
        ...
        // Restart stats polling when the app is reactivated. On iOS this
        // was UIApplication.willEnterForegroundNotification; the AppKit
        // equivalent — fired when the app becomes active again after the
        // user switches back to it — is NSApplication.didBecomeActiveNotification.
    ...
    func connect(config: TunnelConfig) async {
        ...
        do {
            ...
            if config.useCookieAuth {
                ...
                UserDefaults(suiteName: AppGroup.identifier)?.removeObject(forKey: "vkauth_error")
            ...
            proto.providerBundleIdentifier = AppGroup.tunnelProviderBundleID
    ...
    private func wrapADeviceID() -> String {
        let suite = UserDefaults(suiteName: AppGroup.identifier)
